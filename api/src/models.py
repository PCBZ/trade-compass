...
class Holding(BaseModel):
    ...
    security_type: SecurityType = Field(default="NONE", description="Futu security type")
...
class Preferences(BaseModel):
    ...
    sectors: list[str] = Field(default=[], description="Sectors of interest, e.g. ['tech', 'energy']")
